...
- **[EXL101 - Planilhas Eletrônicas para Negócios](/docs/cpaint/previsao-demanda/exl101)**: Domínio da ferramenta essencial e fundamentos de dados estruturados.
...
- **[ANA201 - Análise de Dados](/docs/cpaint/previsao-demanda/ana201)**: Transformando dados em informações úteis para decisão (Curva ABC, séries temporais).
- **[LOG201 - Gestão de Estoque e Cadeia](/docs/cpaint/previsao-demanda/log201)**: Ponto de reposição, dente de serra, curva de suprimento.
...
- **[OPT301 - Otimização de Rotas e Grafos](/docs/cpaint/previsao-demanda/opt301)**: Teoria de grafos aplicada e otimização de rotas de distribuição.
