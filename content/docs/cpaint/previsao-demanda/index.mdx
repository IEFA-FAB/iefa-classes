...
Esta trilha está incluída didaticamente dentro do módulo **"Especialização em Análise de Demanda"** previsto no [PPC](/docs/cpaint/ppc).
...
<Callout type="warn" title="Pré-requisitos Matemáticos">
...
1. **EXCL101 - Planilhas Eletrônicas para Negócios**
...
4. **LOGI201 - Gestão de Estoque e Cadeia**
...
6. **ROUT301 - Otimização de Rotas e Grafos**
...
<Callout type="info" title="Lógica de Progressão">
**EXCL101** e **STAT101** fornecem as ferramentas e a base matemática → **DATA201** ensina a explorar e entender dados → **LOGI201** e **FCST201** aplicam esses conhecimentos para gestão e previsão → **ROUT301** otimiza as decisões de distribuição.
...
flowchart TD
    %% Nível 100
    EXCL101["EXCL101<br/>Excel e Dados"]
    STAT101["STAT101<br/>Estatística Aplicada"]
    
    %% Nível 200
    DATA201["DATA201<br/>Análise de Dados"]
    LOGI201["LOGI201<br/>Gestão de Estoque"]
    FCST201["FCST201<br/>Métodos de Previsão"]
    
    %% Nível 300
    ROUT301["ROUT301<br/>Otimização de Rotas"]
    ...
    class EXCL101,STAT101 nivel100
    class DATA201,LOGI201,FCST201 nivel200
    class ROUT301 nivel300
```
...
- **[EXCL101 - Planilhas Eletrônicas para Negócios](/docs/cpaint/previsao-demanda/excl101)**: Domínio da ferramenta essencial e fundamentos de dados estruturados.
- **[STAT101 - Estatística Aplicada](/docs/cpaint/previsao-demanda/stat101)**: A base matemática necessária para entender incertezas e tendências.

### Nível Intermediário (200)
Aplicação prática dos fundamentos. Requer conclusão de matérias do nível 100.

- **[DATA201 - Análise de Dados](/docs/cpaint/previsao-demanda/data201)**: Transformando dados em informações úteis para decisão (Curva ABC, séries temporais).
- **[LOGI201 - Gestão de Estoque e Cadeia](/docs/cpaint/previsao-demanda/logi201)**: Ponto de reposição, dente de serra, curva de suprimento.
- **[FCST201 - Métodos de Previsão](/docs/cpaint/previsao-demanda/fcst201)**: Aplicação de modelos como Média Móvel, Suavização Exponencial e Regressão.

### Nível Avançado (300)
Otimização e técnicas analíticas avançadas. Requer conclusão de matérias do nível 200.

- **[ROUT301 - Otimização de Rotas e Grafos](/docs/cpaint/previsao-demanda/rout301)**: Teoria de grafos aplicada e otimização de rotas de distribuição.
...
- **Capítulo 22**: Algoritmos Elementares em Grafos (base para ROUT301)
- **Capítulo 24**: Caminhos Mínimos de Fonte Única (Dijkstra em ROUT301)
