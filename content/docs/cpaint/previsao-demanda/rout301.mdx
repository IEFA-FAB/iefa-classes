---
title: ROUT301 - Otimização de Rotas e Grafos
...
| Módulo | Tópico | Tipo |
| :------ | :---------------------------------------- | :--- |
| [Módulo 14](./cronograma) | Teoria dos Grafos e Redes Logísticas | Teoria |
| [Módulo 14](./cronograma) | Modelando problemas reais como grafos | Prática |
| [Módulo 14](./cronograma) | Matrizes de Adjacência e Custos | Lab |
| [Módulo 15](./cronograma) | Algoritmo de Dijkstra (Intuição) | Teoria |
| [Módulo 15](./cronograma) | Dijkstra passo-a-passo (Manual) | Prática |
| [Módulo 16](./cronograma) | Vehicle Routing Problem (VRP) | Teoria |
| [Módulo 16](./cronograma) | Restrições de Capacidade e Tempo | Prática |
| [Módulo 16](./cronograma) | VRP com Múltiplos Veículos | Prática |
| [Módulo 17](./cronograma) | Casos de Uso Militar (Vacinas, Emergência) | Teoria |
...
<Callout type="error" title="O Problema do Caixeiro Viajante (TSP)">
...
<Callout type="info" title="A Armadilha do 'Vizinho Mais Próximo'">
