...
Este plano de aula é fundamentado no **[Projeto Pedagógico de Curso (PPC)](/docs/cpaint/ppc)** (ICA 38-758), que define os objetivos legais, estrutura organizacional e critérios de avaliação do curso.
...
Consulte o [Sistema de Códigos](/docs/cpaint/sistema-de-codigos) para entender a numeração das matérias.
